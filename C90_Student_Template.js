...
if(car1_y>=0){
	car1_y=car1_y-10;
	console.log("when up arrow is pressed, car1_x= "+car1_x+"|car1_y= "+car1_y)
	uploadBackground()
	uploadcar1()
	uploadcar2()
}
	...
	function car1_right(){
		...
		function car1_left(){
			if(car1_x>=0){
				...
				if(car2_y>=0){
					car2_y=car2_y-10;
					console.log("when up arrow is pressed, car2_x= "+car2_x+"|car2_y= "+car2_y)
					uploadBackground()
					uploadcar1()
					uploadcar2()
				}
				...
				function car2_down(){
					...
					function car2_right(){
						...
						function car2_left(){
							if(car2_x>=0){
								car2_x=car2_x-10;
								console.log("when up arrow is pressed, car2x= "+car2_x+"|car2_y= "+car2_y)
								uploadBackground()
								uploadcar1()
								uploadcar2()
							}
